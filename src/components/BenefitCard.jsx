...
//   return (
//     <div
//       className="p- sm:p-6 bg-opacity-75 flex flex-col hover:text-black w-full max-w-xs sm:max-w-none box-content bg-gradient-to-b from-white to-white border-2 sm:border-4 border-blue-200 rounded-xl shadow-lg"
//       style={{ boxShadow: '0 8px 16px rgba(0, 0, 0, 0.7)' }}
//     >
...
//       {/* Heading */}
//       <div
//         className="font-semibold text-xl sm:text-2xl pb-2 text-black"
