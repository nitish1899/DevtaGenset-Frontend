    ...
    <div className="bg-black">
      <div className="w-full relative z-10 py-10 flex justify-center items-center">
        <div className="w-11/12 flex flex-col items-center max-w-[1204px] mx-auto pb-8 text-white bg-white bg-opacity-25 rounded-lg">
          <div className="uppercase text-2xl md:text-3xl font-bold mt-8 pb-5 text-white text-center">Get in Touch</div>
          <div className="flex flex-col gap-5 px-4 md:px-0">
            <div className="flex flex-col md:flex-row justify-center gap-2 md:gap-5 items-center">
              <div>
...
//       <div className='w-full   relative z-10  py-10 flex justify-center items-center  '>
//         <div className='w-11/12 flex flex-col items-center  max-w-[1204px] mx-auto pb-8 text-white  bg-white bg-opacity-25  rounded-lg   '>
//           <div className='uppercase text-3xl font-bold mt-8 pb-5 text-white'>Get in Touch </div>
...
//               </svg>
//               </div>
//               <div>support@devtagensets.com</div>
//             </div>
