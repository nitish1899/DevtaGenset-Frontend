  ...
  return (
    <div className="w-screen bg-gradient-to-b from-white to-white">
      <div className="relative">
          ...
          renderArrowPrev={(onClickHandler, hasPrev, label) =>
            hasPrev && (
              <button
                ...
                title={label}
                className="absolute left-2 sm:left-4 top-1/2 transform -translate-y-1/2 bg-white rounded-full p-1 sm:p-2 z-10"
              >
                <svg
          ...
          renderArrowNext={(onClickHandler, hasNext, label) =>
            hasNext && (
              <button
                ...
                onClick={onClickHandler}
                title={label}
                className="absolute right-2 sm:right-4 top-1/2 transform -translate-y-1/2 bg-white rounded-full p-1 sm:p-2 z-10"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="white"
        ...
        >
          <div>
            <img src={crausal16} alt="Slide 1" className="object-cover w-full h-[60vh] sm:h-[70vh] md:h-[80vh] lg:h-screen" />
          </div>
          <div>
            <img src={home2} alt="Slide 2" className="object-cover w-full h-[60vh] sm:h-[70vh] md:h-[80vh] lg:h-screen" />
          </div>
          <div>
            <img src={home3} alt="Slide 3" className="object-cover w-full h-[60vh] sm:h-[70vh] md:h-[80vh] lg:h-screen" />
          </div>
        </Carousel>

        <div className="absolute inset-0 flex flex-col justify-center items-start p-4 sm:p- md:p-12 mt-12 sm:mt-6 z-20">
          <div className="max-w-full sm:max-w-xl text-white bg-gradient-to-b from-white to-blue-700 rounded-3xl p-4 sm:p-6 md:p-8 mx-2 sm:mx-4 shadow-lg">
            <h1
              className="text-3xl sm:text-2xl md:text-6xl font-bold mb-4"
